import { useFullTimetable } from "@/hooks/use-full-timetable";
import { DAYS, TIMES } from "@/lib/conts";
import { Table, TableBody, TableCell, TableColumn, TableHeader, TableRow } from "@heroui/table";
import { Card, CardBody, CardHeader } from "@heroui/card";
import { extractTimetableEntry } from "@/lib/utils";

export function ExpandedTimetable({ course, batch }: { course: string, batch: string }) {
  const state = useFullTimetable(course);
